...
<h4 class="fw-bold mb-4">مدیریت دسته‌بندی محصولات</h4>
                    ...
                    <tbody>
                        <?php foreach ($categories as $cat): ?>
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="/admin/categories/<?= $cat['id'] ?>/delete" class="d-inline" onsubmit="return confirm('آیا مطمئن هستید؟')">
