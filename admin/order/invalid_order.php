...
$orders = readAllOrdersByStatus(0);
?>
<div class="w-100 p-3">
    <h4 class="text-center p-2">تمامی سفاش ها تایید نشده</h4>
            ...
            <?php foreach ($orders as $order) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="?valid_order_id=<?php echo $order['id'] ?>"
                           class="btn btn-outline-success">تایید سفارش</a>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
